...
export default function ContactPage() {
  return (
    <div className="relative min-h-screen font-sans text-gray-900 dark:text-gray-100 overflow-hidden">
      <Helmet>
      ...
      <div className="absolute inset-0 bg-black/25 dark:bg-black/0 pointer-events-none"></div>
