...
export default function ContactPage() {
  return (
    <div className="relative min-h-screen font-sans text-gray-900 dark:text-gray-100">
      <Helmet>
      ...
      {/* Imagen de fondo */}
      <div 
        className="absolute inset-0 bg-cover bg-center brightness-75 opacity-70"
      ...
      {/* Hero */}
      <section className="relative w-full h-[40vh] flex items-center justify-center text-center overflow-hidden">
      ...
      <main className="relative z-10 max-w-4xl mx-auto pt-16 pb-20 px-6">
        <div className="grid lg:grid-cols-2 gap-8">
          {/* Tarjeta Información de Contacto */}
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4">
              {/* Dirección */}
              <div className="flex items-start gap-4 p-4 hover:bg-gray-50/70 dark:hover:bg-gray-700/50 rounded-lg transition">
          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-2">
                ...
                <li className="flex justify-between bg-gray-100/70 dark:bg-gray-700/50 p-2 rounded-lg">
                  <span>Domingo:</span>
                  <span>Cerrado</span>
                </li>
              </ul>
