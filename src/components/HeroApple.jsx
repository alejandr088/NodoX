  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <video
        ...
        src="/hero-video.mp4"  // Video en carpeta public
      />
      ...
      <motion.div
        ...
        className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center max-w-4xl mx-auto text-white"
      >
